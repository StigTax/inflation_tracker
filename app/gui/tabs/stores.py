...
class StoresTab(QWidget):
    ...
    def reload(self) -> None:
        items = list_items(store_crud, limit=500)
    ...
    def on_add(self) -> None:
        ...
        try:
            create_item(store_crud, Store(name=name, description=desc))
            self.reload()
    ...
    def on_edit(self) -> None:
        ...
        dlg = StoreDialog(self, name=row.get(
        ...
        name, desc = dlg.values()
        try:
            update_item(store_crud, row['id'], name=name, description=desc)
            self.reload()
        except Exception as e:
            QMessageBox.critical(self, 'Ошибка', str(e))
    ...
    def on_delete(self) -> None:
        ...
        try:
            delete_item(store_crud, row['id'], guards=[

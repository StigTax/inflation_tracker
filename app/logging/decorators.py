...
def logged(
    *,
    ...
    Args:
        name: Явное имя события для логирования.
        logger: Логгер, который будет использоваться.
        level: Уровень логирования.
        log_args: Логировать ли аргументы вызова.
        log_result: Логировать ли результат функции.
        maxlen: Максимальная длина отображаемых значений.

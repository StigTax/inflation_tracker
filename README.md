...
- Аналитика и графики: динамика цен/инфляции (индекс Ласпейреса) по выбранным параметрам
...
- Альтернативные индексы цен (Пааше, Фишера) в `service/analytics.py`
  как дополнение к индексу Ласпейреса — для сверки методик;
